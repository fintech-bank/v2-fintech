...
class CustomerTransaction extends Model
{
    ...
    public function getTypeSymbolAttribute($size = 30)
    {
        ...
        return '<div class="symbol symbol-' . $size . 'px symbol-circle me-2" data-bs-toggle="tooltip" title="' . $this->getTypeTextAttribute() . '">
                    <div class="symbol-label bg-'.$this->type_color.'"><span class="iconify text-white" data-icon="' . $this->getTypeIconAttribute() . '"  data-width="' . $size_icon . '" data-height="' . $size_icon . '"></span></div>
                </div>';
    }
