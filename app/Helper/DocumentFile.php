    ...
    )
    {
        ...
        if ($pdf == true) {
            ...
            if($provider == 'gdd') {
                ...
                \Storage::disk('gdd')->put('gdd/'.$customer->user->id.'/documents/'.$categorie->slug.'/'.$nameless.'.pdf', $getFile);
                \Storage::disk('gdd')->setVisibility('gdd/'.$customer->user->id.'/documents/'.$categorie->slug.'/'.$nameless.'.pdf', 'public');
            } else {
                ...
                \Storage::disk($provider)->setVisibility($pathProvider.'/'.$nameless.'.pdf', 'public');
            }
        }
