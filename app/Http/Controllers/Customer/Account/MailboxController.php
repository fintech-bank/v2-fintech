...
class MailboxController extends Controller
{
    ...
    public function index(Request $request, $folder = "")
    {
        if($request->segment(4) == 'create') {
            ...
            return view('customer.account.mailbox.create', compact('folders', 'unreadMessages', 'users'));
            ...
            return view('customer.account.mailbox.index', compact('folders', 'messages', 'unreadMessages'));
        } else {
            $folders = $this->folders;
            $unreadMessages = count(getUnreadMessages());
...
//        $folder = $mailbox->userFolder()->folder()->first();
            ...
            return view('customer.account.mailbox.show', [
                'mailbox' => $mailbox,
...
//        $folder = $mailbox->userFolder()->folder()->first();
        ...
        return view('customer.account.mailbox.show', compact('folders', 'unreadMessages', 'mailbox'));
    }
    ...
    public function getReply($id)
    {
        ...
        $folders = $this->folders;
        $unreadMessages = count(getUnreadMessages());
        return view('customer.account.mailbox.reply', compact('folders', 'unreadMessages', 'mailbox'));
    }
