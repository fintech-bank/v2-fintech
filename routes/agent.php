...
Route::prefix('agence')->middleware(['auth', 'agent'])->group(function () {
    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::prefix('wallet')->group(function () {
            ...
            Route::get('{number_account}/caution', [\App\Http\Controllers\Agent\Customer\CustomerWalletController::class, 'caution'])->name('agent.customer.wallet.caution');
            Route::post('{number_account}/caution', [\App\Http\Controllers\Agent\Customer\CustomerWalletController::class, 'postCaution'])->name('agent.customer.wallet.caution.post');
