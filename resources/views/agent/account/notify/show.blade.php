...
@section('toolbar')
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        <a href="{{ route('agent.account.notify.index') }}" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary"><i class="fa-solid fa-cirlce-left"></i> Retour</a>
    </div>
@endsection
