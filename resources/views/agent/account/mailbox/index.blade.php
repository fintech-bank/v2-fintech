...
@section('toolbar')
    <div class="page-title d-flex justify-content-center flex-column me-5">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <li class="breadcrumb-item text-dark">Mes courriers</li>
        </ul>
    </div>
                        ...
                        @foreach($messages as $message)
                            <tr class="{{ !$message->is_unread ? 'bg-light' : '' }}" data-mailbox-id="{{ $message->id }}" data-mailbox-flag-id="{{ $message->mailbox_flag_id }}" data-user-folder-id="{{ $message->mailbox_folder_id }}">
                                    ...
                                    @if(Request::segment(4) != 'Trash')
                                        <!--begin::Checkbox-->
                                            <div class="form-check form-check-sm form-check-custom form-check-solid mt-3">
                                                <input class="form-check-input" type="checkbox" value="1" data-mailbox-id="{{ $message->id }}" data-mailbox-flag-id="{{ $message->mailbox_flag_id }}" />
                                            </div>
                                            <!--end::Checkbox-->
                                    @endif
                                </td>
                                <td class="min-w-80px">
                                    @if(Request::segment(4) != 'Trash')
                                    <!--begin::Star-->
                                    <a href="#" class="btn btn-icon {{ $message->is_important ? 'btn-warning' : 'btn-color-gray-400' }}  btn-hover-color-primary w-35px h-35px" data-bs-toggle="tooltip" data-bs-placement="right" title="Important">
                                ...
                                <td>
                                    <div class="text-dark mb-1">
                                        <!--begin::Heading-->
                                        <a href="{{ route('agent.account.mailbox.show', $message->id) }}" class="text-dark">
