...
@section('toolbar')
    <div class="page-title d-flex justify-content-center flex-column me-5">
        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Mon agenda</h1>
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <li class="breadcrumb-item text-dark">Mon agenda</li>
        </ul>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <button class="btn btn-flex btn-primary" data-kt-calendar="add"><i class="fa-solid fa-plus me-2"></i> Nouveau rendez-vous</button>
                </div>
            </div>
            <!--end::Card header-->
            <!--begin::Card body-->
                ...
                <form class="form" action="{{ route('agent.account.agenda.store') }}" id="kt_modal_add_event_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="fv-row mb-9">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold required mb-2">Titre</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="fv-row mb-9">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold required mb-2">Type de rendez-vous</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-control form-control-solid" name="type" data-control="select2" data-placeholder="Selectionner un type de rendez-vous">
                                <option value=""></option>
                        ...
                        <div class="fv-row mb-9">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea class="form-control form-control-solid" name="description" cols="10"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-9">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold mb-2">Lieu</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" placeholder="" name="lieu" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-9">
                            ...
                            <label class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" name="allday" type="checkbox" value="" id="kt_calendar_datepicker_allday" />
                                <span class="form-check-label fw-semibold" for="kt_calendar_datepicker_allday">Toute la journée</span>
                            </label>
                            <!--end::Checkbox-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row row-cols-lg-2 g-10">
                            <div class="col">
                                <div class="fv-row mb-9">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" name="start_at" placeholder="Pick a start date" id="kt_calendar_datepicker_start_date" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <div class="col" data-kt-calendar="datepicker">
                                <div class="fv-row mb-9">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" name="start_at_time" placeholder="Pick a start time" id="kt_calendar_datepicker_start_time" />
                                    <!--end::Input-->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-cols-lg-2 g-10">
                            <div class="col">
                                <div class="fv-row mb-9">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" name="end_at" placeholder="Pick a end date" id="kt_calendar_datepicker_end_date" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <div class="col" data-kt-calendar="datepicker">
                                <div class="fv-row mb-9">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" name="end_time_at" placeholder="Pick a end time" id="kt_calendar_datepicker_end_time" />
                                    <!--end::Input-->
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0 pb-20 px-lg-17">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <i class="fa-solid fa-circle text-success fs-2 me-5"></i>
                        <!--end::Svg Icon-->
                        <!--end::Icon-->
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <!--begin::Icon-->
                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs050.svg-->
                        <i class="fa-solid fa-circle text-danger fs-2 me-5"></i>
                        <!--end::Svg Icon-->
                        <!--end::Icon-->
                    ...
                    <div class="d-flex align-items-center mb-9">
                        <i class="fa-solid fa-user-clock fs-2 text-warning me-5"></i>
                        <div class="fs-6">
                            <span class="fw-bold">Durée</span>
                            <span data-kt-calendar="event_duration_date"></span>
                        </div>
                    </div>
                    <!--end::Row-->
                    <!--begin::Row-->
...
@section("script")
    ...
    @include("agent.scripts.account.event.index")
@endsection
