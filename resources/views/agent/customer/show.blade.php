                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <a href="#">
                                    ...
                                    <i class="fa-solid fa-user-check fs-3 {{ $customer->info->isVerified ? 'text-success' : 'text-secondary' }}" data-bs-toggle="{{ $customer->info->isVerified ? "Client Vérifié" : "Client non vérifier" }}"></i>
                                    <!--end::Svg Icon-->
                                </a>
