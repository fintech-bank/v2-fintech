                        ...
                        <div class="card-body">
                            ...
                            <table id="kt_file_manager_list" data-kt-filemanager-table="files" class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0"><th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" style="width: 29.8906px;">
                                    ...
                                    </th><th class="min-w-250px sorting_disabled" rowspan="1" colspan="1" style="width: 520.141px;">Name</th><th class="min-w-10px sorting_disabled" rowspan="1" colspan="1" style="width: 117.594px;">Size</th><th class="min-w-125px sorting_disabled" rowspan="1" colspan="1" style="width: 334.125px;">Last Modified</th><th class="w-125px sorting_disabled" rowspan="1" colspan="1" style="width: 125px;"></th></tr>
                                <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                                ...
                                <tr class="odd">
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-12-20T18:05:00+01:00">20 Dec 2022, 6:05 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                                        ...
                                                        <div class="card-body p-5">
                                                            ...
                                                            <div class="d-flex flex-column text-start d-none" data-kt-filemanger-table="copy_link_result">
                                                                ...
                                                                <div class="text-muted fw-normal mt-2 fs-8 px-3">Read only.
                                                                    <a href="/metronic8/demo1/../demo1/apps/file-manager/settings/.html" class="ms-2">Change permissions</a></div>
                                                            </div>
                                                            <!--end::Link-->
                                                        </div>
                                                    </div>
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-09-22T17:20:00+02:00">22 Sep 2022, 5:20 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-10-25T11:05:00+02:00">25 Oct 2022, 11:05 am</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-11-10T20:43:00+01:00">10 Nov 2022, 8:43 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-09-22T21:23:00+02:00">22 Sep 2022, 9:23 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-10-25T17:20:00+02:00">25 Oct 2022, 5:20 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-10-25T20:43:00+02:00">25 Oct 2022, 8:43 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-09-22T17:30:00+02:00">22 Sep 2022, 5:30 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
                                    ...
                                    <!--end::Size-->
                                    <!--begin::Last modified-->
                                    <td data-order="2022-04-15T21:23:00+02:00">15 Apr 2022, 9:23 pm</td>
                                    <!--end::Last modified-->
                                    <!--begin::Actions-->
                                    <td class="text-end" data-kt-filemanager-table="action_dropdown"><div class="d-flex justify-content-end">
                                            <!--begin::Share link-->
