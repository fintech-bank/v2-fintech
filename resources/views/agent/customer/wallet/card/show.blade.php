    ...
    <div class="card shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <button class="btn btn-xs btn-circle btn-outline btn-outline-primary me-2">Editer la carte</button>
                <button class="btn btn-xs btn-circle btn-outline btn-outline-primary me-2">Renvoyer le code secret</button>
                @if($card->facelia)
                    <button class="btn btn-xs btn-circle btn-outline btn-outline-primary me-2">Liaison Facelia</button>
                @endif
                <button class="btn btn-xs btn-circle btn-outline btn-outline-danger me-2">Annuler la carte bancaire</button>
            </div>
        </div>
        <div class="card-body">
