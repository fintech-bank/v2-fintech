                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="liste_card">
                        ...
                        @foreach($wallet->cards as $card)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('agent.customer.wallet.card', [$card->wallet->customer->id, $card->wallet->number_account]) }}" class="btn btn-sm btn-circle btn-icon btn-bank" data-bs-toggle="tooltip" data-bs-placement="left" title="Détail"><i class="fa fa-desktop"></i> </a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
