                    ...
                    <form id="formAddCredit" class="form" action="{{ route('agent.customer.pret.store', $customer->id) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex-column w-100" data-kt-stepper-element="content">
                                <div class="card shadow-sm" id="validResultPrerequest">
                                    <div class="card-body">
                                        <div class="text-success mb-1" data-content="customerVerified"><i class="fa-solid fa-check-circle text-white fs-3 me-2"></i> Le compte du client est vérifier</div>
                                        <div class="text-success mb-1" data-content="addressVerified"><i class="fa-solid fa-check-circle text-white fs-3 me-2"></i> L'adresse postale du client est vérifier</div>
                                        <div class="text-success mb-1" data-content="incomeVerified"><i class="fa-solid fa-check-circle text-white fs-3 me-2"></i> Les informations de revenues du client sont vérifier</div>
                                    </div>
                                </div>
                            </div>
                            <!--begin::Step 1-->
