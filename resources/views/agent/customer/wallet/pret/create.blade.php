        ...
        <div class="card-body">
            ...
            <div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row" id="credit_stepper">
                ...
                <div class="flex-row-fluid">
                    <!--begin::Form-->
                    <form id="formAddCredit" class="form w-lg-500px mx-auto" action="{{ route('agent.customer.pret.store', $customer->id) }}" method="POST">
                        @csrf
                        <!--begin::Group-->
                        <div class="mb-5">
                            <!--begin::Step 1-->
                            <div class="flex-row current" data-kt-stepper-element="content">
                                <div class="d-flex flex-row w-25">
                                    <div class="symbol symbol-200px me-3">
                                        <div class="symbol-label"><i class="fa-solid fa-user-md fs-4hx text-bank"></i></div>
                                    </div>
