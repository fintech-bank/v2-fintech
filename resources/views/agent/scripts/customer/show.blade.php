<script type="text/javascript">
    ...
    let getFile = (file) => {
        ...
        $.ajax({
            ...
            success: data => {
                console.log(data)
                data.signate === 0 ? modals.modalContentFile.querySelector('.modal-footer').classList.add('d-none') : modals.modalContentFile.querySelector('.modal-footer').classList.remove('d-none');
                modal.show()
                pdf(data.url_folder)
