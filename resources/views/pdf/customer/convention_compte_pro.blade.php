...
@section("content")
    <div class="text-center fs-3 fs-underline">CONVENTION DE COMPTE PROFESSIONNEL</div>
        ...
        <tr>
            <td style="width: 50%;">
                <table style="width: 100%;">
                    <tbody>
                    <tr>
                        <td style="width: 50%;">Société / Organisme</td>
                        <td style="width: 50%;">{{ $customer->info->company }}</td>
                    </tr>
                    <tr>
            ...
            <td style="width: 50%;">
                <table style="width: 100%;">
                    <tbody>
                    <tr>
                        <td style="width: 50%;">Siret</td>
                        <td style="width: 50%;">{{ $customer->info->siret }}</td>
                    </tr>
                    </tbody>
                </table>
            </td>
    ...
    <p class="fs-underline fs-3">COMPTE DE PROFESSIONNEL</p>
