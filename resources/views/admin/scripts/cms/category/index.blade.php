<script type="text/javascript">
    ...
    let elements = {
        ...
        btnSubtable: document.querySelectorAll('.btnSubtable'),
    }
    let modals = {
        modalEditCategory: document.querySelector("#EditCategory"),
        modalShowSubtable: document.querySelector("#ShowSubtable")
    }
    let forms = {
    ...
    if(elements.btnSubtable) {
        elements.btnSubtable.forEach(btn => {
            btn.addEventListener('click', e => {
                e.preventDefault()
