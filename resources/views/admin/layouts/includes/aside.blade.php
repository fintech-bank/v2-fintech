            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Distributeur</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Catégorie de documents</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Plan d'épargne</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Type de pret</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Forfait</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Services bancaires</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-title">Log Bancaire</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="/log-viewer">
						<span class="menu-icon">
							<i class="fa-solid fa-bug fa-2x"></i>
						</span>
                        <span class="menu-title">Log Système</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="/backup">
                        ...
                        <span class="menu-title">Sauvegardes</span>
                    </a>
                    <!--end:Menu link-->
                </div>
            </div>
