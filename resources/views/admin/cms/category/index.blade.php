...
@section('toolbar')
    <div class="page-title d-flex justify-content-center flex-column me-5">
        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Catégorie de pages</h1>
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <li class="breadcrumb-item text-muted">
                <a href=""
                   class="text-muted text-hover-primary">CMS</a>
            </li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-200 w-5px h-2px"></span>
            </li>
            <li class="breadcrumb-item text-dark">Catégorie de pages</li>
        </ul>
    </div>
...
<div class="card card-flush shadow-sm">
    <div class="card-header">
        <h3 class="card-title">Liste des catégories de page</h3>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_category_table" aria-describedby="Liste des banque">
            ...
            @foreach($categories as $category)
                <tr>
                    ...
                    <td class="text-end">
                        <button class="btn btn-circle btn-icon btn-light btnSubtable" data-category="{{ $category->id }}"><i class="fa-solid fa-table" data-category="{{ $category->id }}"></i> </button>
    ...
    <div class="modal fade" tabindex="-1" id="AddCategory">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formAddCategory" action="{{ route('admin.cms.category.store') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="ShowSubtable">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header bg-bank">
                    <h3 class="modal-title text-white">Liste des sous-catégorie</h3>
