        ...
        <div class="card shadow-sm rounded">
            <div class="card-body bg-gray-300 rounded">
                @foreach($notifications as $notification)
                    <a href="{{ route('customer.account.notify.show', $notification->id) }}" class="card {{ $notification->read_at == null ? 'shadow-lg border border-2 border-black' : 'shadow-sm' }} mb-10 text-black">
