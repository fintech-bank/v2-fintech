        ...
        <div class="card shadow-sm rounded">
            <div class="card-body bg-gray-300 rounded">
                @foreach($notifications as $notification)
                    <a href="{{ route('customer.account.notify.show', $notification->id) }}" class="card {{ $notification->read_at == null ? 'shadow-lg border border-2 border-gray-800' : 'shadow-sm' }} mb-10 text-black">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-row justify-content-between">
                                ...
                                <div class="text-active-primary"><i class="fa-solid fa-arrow-right-long text-active-primary"></i> </div>
                            </div>
                        </div>
                    </a>
                @endforeach
