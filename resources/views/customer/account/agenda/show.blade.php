                ...
                <div class="card" id="kt_chat_messenger">
                    ...
                    <div class="card-header" id="kt_chat_messenger_header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Menu-->
                            <div class="me-n3">
                                <button class="btn btn-sm btn-icon btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-dashlane-rid="567ad1da4e6137e1">
