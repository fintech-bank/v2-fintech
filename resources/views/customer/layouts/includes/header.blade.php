        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    @if(Route::is('customer.compte.index') || Route::is('customer.compte.card.index') || Route::is('customer.compte.card.show') || Route::is('customer.compte.transfer.index') || Route::is('customer.compte.sepa.index') || Route::is('customer.compte.budgets.index') || Route::is('customer.compte.offers.index'))
                        ...
                        <a href="{{ route('customer.compte.card.index', $wallet->uuid) }}" class="menu-item {{ Route::is('customer.compte.card.index') || Route::is('customer.compte.card.show') ? 'here' : '' }} me-0 me-lg-2">
                            <span class="menu-link">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--begin::Menu- wrapper-->
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-45px h-45px w-md-50px h-md-50px position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <i class="fa-regular fa-bell"></i>
                        <span class="position-absolute top-0 start-100 translate-middle  badge badge-circle badge-sm badge-danger unreadNotifyBadge" data-user="{{ auth()->user()->id }}"></span>
                    </div>
                    <!--begin::Menu-->
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--begin::Menu- wrapper-->
                    <a href="{{ route('customer.account.mailbox.index') }}" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-45px h-45px w-md-50px h-md-50px position-relative">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <!--begin::Menu- wrapper-->
                    <a href="{{ route('customer.account.agenda.index') }}" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-45px h-45px w-md-50px h-md-50px">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        {!! \App\Helper\UserHelper::getAvatar(auth()->user()->email) !!}
                    </div>
